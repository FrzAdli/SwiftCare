...
public class CustomDialogSuccessFundraise extends DialogFragment {
    ...
    public void setSuccessCondition() {
        new Handler().postDelayed(() -> {
            ...
            binding.messageTextView1.setText("Success");
            binding.messageTextView2.setText("Your application will be immediately checked by our team");
